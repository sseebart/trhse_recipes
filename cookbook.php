...
$granola_muffins->addTag("snack");
$granola_muffins->addTag("quick bread");
$granola_muffins->setSource("Alena Holligan (Treehouse)");

Store::store_recipe($db, $granola_muffins);
...
$belgian_waffles->addTag("quick bread");
$belgian_waffles->setSource("Alena Holligan (Treehouse)");

Store::store_recipe($db, $belgian_waffles);
...
$pepper_casserole->setSource("Alena Holligan (Treehouse)");
$pepper_casserole->addTag("dinner");

Store::store_recipe($db, $pepper_casserole);
...
$lasagna->addTag("dinner");
$lasagna->addTag("italian");

Store::store_recipe($db, $lasagna);
...
$dried_mushroom_ragout->setYield("5 four ounce servings.");
$dried_mushroom_ragout->setSource("Alice Kingsleigh (Treehouse)");
$dried_mushroom_ragout->addTag("dinner");

Store::store_recipe($db, $dried_mushroom_ragout);
...
$rabbit_catalan->setYield("4 seven ounce servings.");
$rabbit_catalan->setSource("Elmer Fudd");
$rabbit_catalan->addTag("dinner");

Store::store_recipe($db, $rabbit_catalan);
echo Render::displayRecipe($rabbit_catalan);
...
Store::store_recipe($db, $grilled_salmon_with_fennel);
echo Render::displayRecipe($grilled_salmon_with_fennel);
...
$pistachio_duck->addIngredient("Wild Rice, cooked", .3, "cup");
$pistachio_duck->addIngredient("White Rice, cooked", .3, "cup");
$pistachio_duck->addIngredient("Egg plant", .25);
...
$pistachio_duck->setSource("S.J. Sharkie (Treehouse)");
$pistachio_duck->addTag("dinner");

Store::store_recipe($db, $pistachio_duck);
echo Render::displayRecipe($pistachio_duck);
...
Store::store_recipe($db, $chili_pork);
echo Render::displayRecipe($chili_pork);
...
Store::store_recipe($db, $crab_cakes);
...
Store::store_recipe($db, $beef_medallions);
echo Render::displayRecipe($beef_medallions);
...
Store::store_recipe($db, $silver_dollar_cakes);
echo Render::displayRecipe($silver_dollar_cakes);
...
Store::store_recipe($db, $french_toast);
echo Render::displayRecipe($french_toast);
...
Store::store_recipe($db, $corn_beef_hash);
echo Render::displayRecipe($corn_beef_hash);
...
Store::store_recipe($db, $spicy_omelette);
echo Render::displayRecipe($spicy_omelette);
...
Store::store_recipe($db, $scones);
echo Render::displayRecipe($scones);
